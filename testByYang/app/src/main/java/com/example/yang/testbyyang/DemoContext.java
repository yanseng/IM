...
import com.example.yang.testbyyang.database.DBHelper;
import com.example.yang.testbyyang.database.UserInfos;
import com.example.yang.testbyyang.database.UserInfosDao;
...
public class DemoContext {
    ...
    private DemoContext(Context context) {
        ...
        mUserInfoDao = DBHelper.getInstance(mContext).getDaoSession().getUserInfosDao();
    }
