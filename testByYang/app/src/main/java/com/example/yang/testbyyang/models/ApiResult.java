...
public class ApiResult implements Serializable,Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        ParcelUtils.writeToParcel(dest, getPortrait());
        ParcelUtils.writeToParcel(dest, getToken());
        ParcelUtils.writeToParcel(dest, getIntroduce());
        ParcelUtils.writeToParcel(dest, getNumber());
        ParcelUtils.writeToParcel(dest, getMax_number());
        ParcelUtils.writeToParcel(dest, getCreat_datetime());
        ParcelUtils.writeToParcel(dest, getCreate_user_id());
